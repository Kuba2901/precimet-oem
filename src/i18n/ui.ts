...
export const ui: Record<Locale, Dict> = {
  ...
  pl: {
    ...
    hero: {
      ...
      titleAccent: 'na rysunek klienta.',
      title2: 'Od prototypu po serię.',
      lead:
        'Jesteśmy zapleczem produkcyjnym dla firm OEM, integratorów i producentów maszyn. Tniemy laserem, gniemy, spawamy, frezujemy i montujemy — na czas, powtarzalnie i zgodnie z dokumentacją.',
  ...
  de: {
    ...
    contact: {
      ...
      info: {
        ...
        hours: 'Mo–Fr: 7:00–15:00 Uhr MEZ',
